        ...
        <section class="card_block_first container">
            ...
            <div class="container my-5 pb-5 d-flex justify-content-center">
                <div class="picture d-flex justify-content-center align-items-center">
                    <img src="/image/<?=$card['img']?>" alt="#">
                    <div class="text-start mx-5 p-5 text-dark">
                        <h3 class="fw-bold my-0"><?=$card['name']?></h3>
                        <h4 class="product-сart-description mb-3"><?=$card['name-description']?></h4>
                        ...
                        <?php 
                            if (isset($_SESSION['cart-list'])):
                                ...
                                if ($checked): ?>
                                    <a href="cart.php"><button type="button" class="btn btn-dark">Добавлено</button></a>                          
                                <?php else: ?>
                                    <a href="cart.php?goods_add_id=<?=$card['id']?>"><button type="button" class="btn btn-dark">В корзину</button></a>
                                 <?php endif;
