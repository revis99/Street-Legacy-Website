...
<body>
    ...
    <main>
        <div class="container content my-4 pb-5">
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    <a href="male.php" class="list-group-item text-center">Мужское</a>
                    <a href="female.php" class="list-group-item text-center">Женское</a>
                    <a href="baby.php" class="list-group-item text-center">Детское</a>
                </div>
            </div>
            <?php
                    ...
                    <div class="col-sm-4">
                        <div class="product">
                            <div class="product-img mx-5 p-2">
                                <a href="card.php?id=<?=$row['id']?>"><img class="p-4" src="../image/<?=$row['img']?>" alt="Продукт из каталога"></a>
                            </div>
