...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                    <a class="nav-link" href="../pages/catalog.php">Новости</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="../pages/catalog.php">Часы</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="../pages/catalog.php">Подарочные карты</a>
                    </li>
                    <li class="nav-item">
    ...
    <main>
        ...
        <section class="first_block_contact container text-center">
            <h3>Контакт центр</h3>
            ...
            store@streetlegacy.ru</p>
        </section>
        <section class="second_block_contact container text-center">
            <h2 class="text">Наш магазин</h2>
            <div class="our_shop text-center">
                <div class="shop">
                    <a href="#"><h5 >Street Legacy</h5></a>
                    <p>Новослободская ул. 24Ac2, Москва, Россия<br>
                    Режим работы – с 10:00 до 22:00, ежедневно</p>
                    <img class="border rounded" src="../image/shops/shop3.jpg" alt="shop1">
                </div>
            </div>
        </section>
        </section>
        <section class="container   map">
            ...
            <iframe class="border rounded" src="https://yandex.ru/map-widget/v1/?um=constructor%3A6512b7c85f8df07c4dde3b1e28580b3ab5841a8d15e00671100c3bb984130684&amp;source=constructor"  frameborder="0"></iframe>
        </section>
    </main>
    <footer>
