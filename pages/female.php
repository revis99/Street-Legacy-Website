        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    <a href="../pages/male.php" class="list-group-item text-center">Мужское</a>
                    <a href="../pages/female.php" class="list-group-item text-center">Женское</a>
                    <a href="../pages/baby.php" class="list-group-item text-center">Детское</a>
                </div>
            </div>
            <?php
