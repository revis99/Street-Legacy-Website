    ...
    <main>
        <section class="container pb-5">
            <div class="d-flex justify-content-center">
                <div class="col-6">
                <h3 class="pt-4 text-center fw-bold">ПОДАРОЧНАЯ КАРТА</h3>
                <p class="text-center">Подарочные карты позволяют преподнести подарок<br>любимым, не выходя из дома.</p>
                <img src="../image/gifcard.jpg" alt="#">
                <div class="button d-flex justify-content-center">  
                <button type="button" class="btn btn-outline-danger btn-lg">Купить подарочную карту</button>
                    </div>
                </div>
            </div>
        </section>
